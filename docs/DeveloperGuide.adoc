= VoluncheerBook Level 4 - Developer Guide
...
[discrete]
=== Use case 11: export volunteer list
...
1.  User requests to make a filtered list of volunteers.
2.  VoluncheerBook shows the successful filtered list.
+
Use case ends.
