...
** Explanation of features implemented
    ...
    *allows the user to assign a Requried number of `Volunteers` to the `Project` selected*
...
** Project management:
*** Team Lead for the project, in charge of ensuring project submissions are accurate and before the deadline.
...
include::C:\Users\Quinn\Desktop\Y2S2\CS2113T\Project\AddressBook4\docs\UserGuide.adoc[tag=ProjectMangement]
