...
Format: `addBeneficiary n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...`
...
* `addBeneficiary n/Sunshine Old Folks Home p/67580392 e/sunny@oldfolks.sg a/sunshine ave 5`
...
=== Listing all volunteers : `listBeneficiary`
