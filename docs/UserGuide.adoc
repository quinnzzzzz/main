...
Now let's just go though quick overview of our VolunCHeer application.
...
. Command Result:
This is where the results of all your commands are displayed. useful tips and error messages are also shown here.
