...
public class VolunteerSampleDataUtil {
    public static Volunteer[] getSampleVolunteers() {
        return new Volunteer[]{
            new Volunteer(new Name("Alex Yeoh"), new Age("22"), new Gender("m"), new Race("Chinese"),
                new Religion("Christian"), new Phone("87438807"),
                ...
                getTagSet("friends")),
            new Volunteer(new Name("Bernice Yu"), new Age("19"), new Gender("f"), new Race("Chinese"),
                new Religion("Atheist"), new Phone("99272758"),
            ...
            new Volunteer(new Name("Charlotte Oliveiro"), new Age("27"), new Gender("f"), new Race("Caucasian"),
                new Religion("Christian"), new Phone("93210283"),
            ...
            new Volunteer(new Name("David Li"), new Age("44"), new Gender("m"), new Race("Chinese"),
                new Religion("Free thinker"), new Phone("91031282"),
                ...
                getTagSet("family")),
            new Volunteer(new Name("Irfan Ibrahim"), new Age("33"), new Gender("m"), new Race("Malay"),
                new Religion("Muslim"), new Phone("92492021"),
            ...
            new Volunteer(new Name("Roy Balakrishnan"), new Age("20"), new Gender("m"), new Race("Indian"),
                new Religion("Indian"), new Phone("92624417"),
