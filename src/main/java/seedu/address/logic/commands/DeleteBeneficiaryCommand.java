...
public class DeleteBeneficiaryCommand extends Command {
    ...
    public static final String MESSAGE_DELETE_PERSON_SUCCESS = "Deleted Beneficiary: %1$s";
    ...
    public CommandResult execute(Model model, CommandHistory history) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_DELETE_PERSON_SUCCESS, beneficiaryToDelete));
    }
