...
public class SelectCommandSystemTest extends AddressBookSystemTest {
    ...
    public void select() {
        ...
        /* Case: filtered volunteer list, select index within bounds of address book but out of bounds of volunteer list
         * -> rejected
         */
     ...
     * {@code expectedSelectedCardIndex} of the selected volunteer.<br>
    ...
    private void assertCommandSuccess(String command, Index expectedSelectedCardIndex) {
        ...
        String expectedResultMessage = String.format(
                MESSAGE_SELECT_VOLUNTEER_SUCCESS, expectedSelectedCardIndex.getOneBased());
        int preExecutionSelectedCardIndex = getVolunteerListPanel().getSelectedCardIndex();
