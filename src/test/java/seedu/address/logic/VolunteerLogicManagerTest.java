...
public class VolunteerLogicManagerTest {
    ...
    public void execute_validCommand_success() {
        String listCommand = ListVolunteerCommand.COMMAND_WORD;
        assertCommandSuccess(listCommand, ListVolunteerCommand.MESSAGE_SUCCESS, model);
    ...
    public void execute_storageThrowsIoException_throwsCommandException() throws Exception {
        ...
        // Execute add command
        String addCommand = AddVolunteerCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY;
    ...
    public void getFilteredVolunteerList_modifyList_throwsUnsupportedOperationException() {
        ...
        logic.getFilteredVolunteerList().remove(0);
    }
