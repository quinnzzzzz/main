...
public class EditVolunteerDescriptorTest {
    ...
    public void equals() {
        ...
        EditVolunteerDescriptor editedAmy = new EditVolunteerDescriptorBuilder(DESC_AMY).withName(VALID_NAME_BOB).build();
        ...
        editedAmy = new EditVolunteerDescriptorBuilder(DESC_AMY).withTags(VALID_TAG_HUSBAND).build();
        assertFalse(DESC_AMY.equals(editedAmy));
    }
}
