...
public class EditVolunteerCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        EditVolunteerCommand editCommand = new EditVolunteerCommand(INDEX_FIRST_VOLUNTEER, descriptor);
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() {
        ...
        EditVolunteerCommand editCommand = new EditVolunteerCommand(indexLastVolunteer, descriptor);
    ...
    public void execute_noFieldSpecifiedUnfilteredList_success() {
        EditVolunteerCommand editCommand = new EditVolunteerCommand(INDEX_FIRST_VOLUNTEER, new EditVolunteerDescriptor());
    ...
    public void execute_filteredList_success() {
        ...
        EditVolunteerCommand editCommand = new EditVolunteerCommand(INDEX_FIRST_VOLUNTEER,
    ...
    public void execute_duplicateVolunteerUnfilteredList_failure() {
        ...
        EditVolunteerCommand editCommand = new EditVolunteerCommand(INDEX_SECOND_VOLUNTEER, descriptor);

        assertCommandFailure(editCommand, model, commandHistory, EditVolunteerCommand.MESSAGE_DUPLICATE_VOLUNTEER);
    }
    ...
    public void execute_invalidVolunteerIndexUnfilteredList_failure() {
        ...
        EditVolunteerCommand editCommand = new EditVolunteerCommand(outOfBoundIndex, descriptor);

        assertCommandFailure(editCommand, model, commandHistory, Messages.MESSAGE_INVALID_VOLUNTEER_DISPLAYED_INDEX);
    }
    ...
    public void execute_invalidVolunteerIndexFilteredList_failure() {
        ...
        EditVolunteerCommand editCommand = new EditVolunteerCommand(outOfBoundIndex,
                new EditVolunteerDescriptorBuilder().withName(VALID_NAME_BOB).build());
